        ...
        OnGetPoiSearchResultListener getPoiSearchResultListener=new OnGetPoiSearchResultListener() {
            ...
            public void onGetPoiResult(PoiResult poiResult) {
                ...
                if(poiResult.error==SearchResult.ERRORNO.NO_ERROR){
                    ...
                    overlay.zoomToSpan();
                    Toast.makeText(MainActivity.this,"总数查到"+poiResult.getTotalPageNum()+"个信息点，分为"+poiResult.getTotalPageNum()+"页",Toast.LENGTH_SHORT).show();
                    return;
                }
            }
            ...
            public void onGetPoiDetailResult(PoiDetailResult poiDetailResult) {
               if(poiDetailResult.error!=SearchResult.ERRORNO.NO_ERROR){
                   Toast.makeText(MainActivity.this,"抱歉,为找到结果",Toast.LENGTH_SHORT).show();
               }else{
